...
Loads: saved_model/lstm_generator.keras + processed_data/CCAB.pkl
Saves: run_results/base_generated_smiles_CN.smi, run_results/base_generated_molecules_CN.png
"""
...
MODEL_PATH = os.path.join(ROOT, "saved_model", "lstm_generator.keras")
...
smi_path = os.path.join(OUT_DIR, "base_generated_smiles_CN.smi")
...
if valid:
    ...
    if mols:
        img_path = os.path.join(OUT_DIR, "base_generated_molecules_CN.png")
